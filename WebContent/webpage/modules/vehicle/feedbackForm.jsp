...
<body>
		<form:form id="inputForm" modelAttribute="vFeedback" action="${ctx}/vehicle/feedback/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>	
		<input type="hidden" id="picturesHidden" value='${vFeedback.pictures}'/>	
