...
<script type="text/javascript">
	...
	layui.use('layedit', function(){
	  ...
	  layedit.set({
		  uploadImage: {
		    url: '${ctx}/vehicle/pictures/upload', //接口url
		    type: 'post' //默认post	    	
		  }
		});
		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
				<tr>
					...
					<td class="width-85">
						<textarea class="layui-textarea" id="lay_editor" style="display: none">${fn:escapeXml(vNews.content)}</textarea>
					</td>
				</tr>
				<form id="inputForm" modelAttribute="vNews" action="${ctx}/vehicle/news/save" method="post" class="form-horizontal">
				<input type="hidden" name="id" value="${vNews.id}"/>
				<input type="hidden" name="state" value="${vNews.state}" id="state_value"/>
				<input type="hidden" name="content" value='${fn:escapeXml(vNews.content)}' id="editor_content"/>
				<tr>
					<td class="width-15 active"><label class="pull-right"><font color="red">* </font>标题：</label></td>
					<td class="width-85">
						<input name="title" value='${fn:escapeXml(vNews.title)}' maxlength="20" class="form-control required"/>
					</td>
				</tr>
				<tr>
					<td class="width-15 active"><label class="pull-right"><font color="red">* </font>标签：</label></td>
					<td class="width-85">
						<input name="label" value='${fn:escapeXml(vNews.label)}' maxlength="10" class="form-control required"/>
					</td>
				</tr>
				<tr>
		             <td class="width-15 active"><label class="pull-right"><font color="red">* </font>摘要：</label></td>
		             <td class="width-85"><textarea name="summary" rows="3" maxlength="200" class="form-control required">${fn:escapeXml(vNews.summary)}</textarea></td> 		         
		        </tr>	
				<%-- <tr>
				...
				<tr>
					...
					<td class="width-85">
							<div class="i-checks">
							<input type="radio" class="check" ${vNews.state==true?"checked":""} name="state0" data-radio="iradio_square-green" value="1">
	                        <label for="state1">显示</label>
	                        <input type="radio" class="check" ${vNews.state==true?"":"checked"} name="state0" data-radio="iradio_square-green" value="0">
				...
				<tr>
					...
					<td class="width-85">
						<input name="sort" value='${vNews.sort}' maxlength="2" class="form-control required"/>
						<span>数字越小越靠前显示</span>						
					</td>				
				</tr>
				</form>
